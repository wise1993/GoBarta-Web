            ...
            <section style='background:#E5E5E5'>
                <div style='max-width: 900px; margin: auto;'>
                    ...
                    <div style='background:white; padding:2em; border:1px solid #ffffff;'>
                        ...
                        <button style='color:#1C1F26; background: #00D57C;border-radius: 10px;padding: 10px; border: none;'>
                            <a href='http://gobarta.com/'>Continue to Website</a>
                        </button>
...
curl_setopt($ch, CURLOPT_USERPWD, "f9b62b31d965d7dc8dbaa6c5f2af0595:67fd5400838f14f345ab2bc148b3193c");
...
if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
    ...
    fwrite($myfile, $txt);
    fclose($myfile);
    $emailSuccess = "<span class='successMail'><img src='http://gobarta.com/assets/images/success-icon.png'> Yay! You’re now on our early access list. </span>";
...
<body>
   ...
   <!-- Cookies -->
    <input onclick="myFunction()" name="cookieData" type="hidden" data-cookie-customDialogSelector='null' data-cookie-colorText='#424a4d'
        ...
        data-cookie-text="We use cookies to give you the best experience. Read our <a href='http://gobarta.com/privacy.php'>cookie policy</a>.">
    <!-- Cookies end -->
